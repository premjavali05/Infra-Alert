document.addEventListener('DOMContentLoaded', () => {
    ...
    // Function to populate department based on selected state and category
    ...
    // Event listeners for state and category changes
    stateSelect.addEventListener('change', populateDepartments);
    categorySelect.addEventListener('change', populateDepartments);
});
