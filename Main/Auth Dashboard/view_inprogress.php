<?php
  ...
  $sql1 = "SELECT * FROM complaint WHERE category = '$category' AND dept = '$dept' AND state = '$state' AND city = '$city' AND status = 'In Progress' ";
  $result1 = mysqli_query($connect,$sql1);

  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $eid = $_POST['eid'];
    $cid = $_POST['cid'];
    header("Location: inprogress_filter.php?eid=$eid&cid=$cid");
    exit;
    }
