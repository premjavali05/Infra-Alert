<?php
  ...
  $sql1 = "SELECT * FROM complaint WHERE category = '$category' AND dept = '$dept' AND state = '$state' AND city = '$city' AND status = 'In Progress' AND cid = '$cid' ";
...
<head>
    ...
    <title>In Progress Filter</title>
