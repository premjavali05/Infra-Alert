<?php
    ...
    require_once("../Dashboard/fpdf184/font/helveticab.php");
    ...
    $pdf->AddPage();
    $pdf->SetFont("Arial", 'B', 16);
    $pdf->Cell(0, 20, 'Final Complaint Form', 0, 1, 'C');
    ...
    // Add Image URL
    $pdf->Cell(50, 10, "Complaint Image:", 0, 0);
    //$pdf->Cell(140, 10, $img_url, 0, 1);
    $pdf->Image($img_url, 60, $pdf->GetY(), 90, 0, '', '', '', false, 300, '', false, false, 0, false, false, false);

    $pdf->Ln(100);

    $pdf->Cell(50, 10, "Solved Image:", 0, 0);
    //$pdf->Cell(140, 10, $img_url, 0, 1);
    $pdf->Image($row['solved_url'], 60, $pdf->GetY(), 90, 0, '', '', '', false, 300, '', false, false, 0, false, false, false);
    $pdf->Output();
